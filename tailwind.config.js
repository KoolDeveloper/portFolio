  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        miniNav: "miniNav 6s steps(1) infinite",
        miniSidebar1: "miniSidebar1 6s steps(1) infinite",
        miniSidebar2: "miniSidebar2 6s steps(1) infinite",
        miniMain: "miniMain 6s steps(1) infinite",
        miniFooter: "miniFooter 6s steps(1) infinite",
      },
      fontFamily: {
